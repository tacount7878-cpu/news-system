...
function runTodayPayload() {
  applyAnalysisPayloadByBlankRows({
    ...
    iMap: {
      "2026-05-03|TSMC": "公平定價與合作題材升溫 但處置風險需留意",
      "2026-05-03|TW0050": "台指夜盤強彈逼近高點 短線不追價",
      "2026-05-03|BOND": "Fed接班雜音升高 降息路徑仍分裂",
      "2026-05-03|GOOGL": "Alphabet財報優於預期 AI動能延續",
      "2026-05-03|BTC": "機構加倉延續牛市敘事 但波動仍高",
      "2026-05-03|GOLD": "金價急跌後觀望 等回檔訊號更穩",
      "2026-05-03|TSLA": "Semi量產屬產品利多 結構仍待驗證",
      "2026-05-03|GLOBAL": "企業獲利強但熊市預警升溫 先保守觀察"
    }
  });
}
